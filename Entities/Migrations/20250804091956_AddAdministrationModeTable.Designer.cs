...
namespace Entities.Migrations
{
    ...
    [Migration("20250804091956_AddAdministrationModeTable")]
    partial class AddAdministrationModeTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.Assistant", b =>
                {
                    ...
                    b.HasIndex("SupervisorPharmacistId");
            ...
            modelBuilder.Entity("Entities.Models.Medication", b =>
                {
                    ...
                    b.Property<string>("ActiuneTerapeutica")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("ActiuneTerapeutica");
                    ...
                    b.Property<string>("Dreptunghi")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("Dreptunghi");

                    b.Property<string>("FirmaDetinatoare")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("FirmaDetinatoare");

                    b.Property<string>("FirmaProducatoare")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("FirmaProducatoare");
                    ...
                    b.Property<string>("NrData")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("NrData");

                    b.Property<string>("Prescriptie")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("Prescriptie");
                    ...
                    b.Property<string>("Valabilitate")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("Valabilitate");

                    b.Property<string>("VolumAmbalaj")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("VolumAmbalaj");
            ...
            modelBuilder.Entity("Entities.Models.PrescriptionMedication", b =>
                {
                    ...
                    b.HasIndex("AdministrationModeId");
